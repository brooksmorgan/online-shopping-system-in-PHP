         ...
         <hr>
          ...
          <li class="active">
            <a href="order_items.php">
              <i class="nc-icon nc-bullet-list-67"></i>
           <b>  <h5 style="color:blue;"> <p>Order Items</p></h5></b>
            </a>
          </li>
        ...
        <div class="row">
         ...
         <table class="table">
                    ...
                    <tr>
                      ...
                      <td style="font-size:13px;"><?php echo $row['item_price']; ?></td>              
                      <td style="font-size:13px;"><?php echo $row['quantity']; ?></td>
