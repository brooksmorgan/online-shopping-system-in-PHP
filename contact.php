<?php
  $title = "Contact";
  require_once "./template/header9.php";
?>
    <div class="row">
			...
			<form class="form-horizontal">
			  	<fieldset>
				    ...
				    <div class="form-group">
				      	...
				      	<div class="col-lg-10">
						  <input type="email" class="form-control" name="email" placeholder="Email" required="true" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required="true">
				      	</div>
				    </div>
				    <div class="form-group">
