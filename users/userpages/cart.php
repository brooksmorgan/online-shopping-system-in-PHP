   ...
   <div class="panel-heading">
      <h4 style="color:green;">CHECKOUT</h4>
   	...
   	<form action="cart.php" method="post">
		   ...
		   <li class="nc-icon nc-refresh-69   " style="font-size:17px; color:blue;"> </li>
		   <input type="submit" class="btn btn-link"  style ="font-size:17px;" name="save_change" value="Save Changes">
		  
		 <a href="pay.php" class="btn btn-info nc-icon nc-check-2 " style="font-size:18px;"> Proceed To Checkout</a> 
	</form>
</div>
 </div>
</b>  
