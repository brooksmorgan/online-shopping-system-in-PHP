<?php
    ...
    if(!preg_match($regex_email,$email)){
        ...
        ?>
         <script>
            window.alert("Incorrect email. Redirecting you back to registration page...");
        </script>
    ...
    if(strlen($password)<6){
        ...
        ?>
         <script>
            window.alert("Password should have atleast 6 characters. Redirecting you back to registration page...");
        </script>
    ...
    if($rows_fetched>0){
        ...
        <meta http-equiv="refresh" content="3;url=books.php" />
        <?php
    }
