...
<div class="col-lg-10">
	...
	<div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-11">
              	<input type="number" class="form-control" name="zip_number" placeholder="+233 or 00233" required="true" >
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-11">
              	<input type="number" class="form-control" name="tel_unmber" placeholder="Example 0244644700" maxlength="10" required="true">
            </div>
        </div>
</b>
